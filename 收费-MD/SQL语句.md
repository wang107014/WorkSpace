...
##急诊病人列表
	...
	SELECT * FROM DHCQueue WHERE ID IN (3240,3248)
	
	SELECT PAADM_CurrentWard_DR, * FROM PA_Adm WHERE PAADM_RowID IN (5827)

	SELECT * FROM PAC_Ward WHERE WARD_RowID=2
	
	SELECT * FROM PA_PatMas WHERE PAPMI_No IN ('020000003629','020000000190')
