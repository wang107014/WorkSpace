...
//医嘱项
SELECT * FROM ARC_ItmMast WHERE ARCIM_RowId='18038||1'

SELECT * FROM ARC_ItmMast WHERE ARCIM_Desc['常规12导心电图检查'
///项目子项
...
SELECT * FROM PA_Adm WHERE PAADM_RowID='3329'


SELECT * FROM PA_PatMas WHERE PAPMI_RowId1=2020
...
////体检结果
select * from DHC_PE_Result WHERE RLT_ARCIM_DR='18038||1' AND RLT_Result['P波于' --RLT_ADM_DR=156 --RLT_OD_DR='1||41' AND RLT_Result["170.2"



SELECT * FROM DHC_PE_Result WHERE RLT_ADM_DR="156" AND RLT_ARCIM_DR='18038||1'
