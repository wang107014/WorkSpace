...
///病人医嘱费用明细表
SELECT  * FROM DHC_PatBillOrder WHERE PBO_PB_ParRef IN ('475827','475828')


///账单收费项目明细表
SELECT PBD_TARI_DR->TARI_Desc 收费项目, * FROM DHC_PatBillDetails WHERE PBD_PBO_ParRef IN ('475827','475828')
...
////门诊计费药房中间表
///PHA_FINFLAG:发药标志
SELECT PHA_PHW_DR->PHW_DESC,PHA_FINFLAG, * FROM  DHC_PHARWIN WHERE PHA_PRT_DR IN (419270)
