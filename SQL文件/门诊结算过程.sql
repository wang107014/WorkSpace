...
SELECT * FROM PA_PatMas WHERE PAPMI_No="020000019683"
SELECT * FROM DHC_INVPRT WHERE PRT_PAPMI_DR='22104'

SELECT * FROM PA_Adm WHERE PAADM_PAPMI_DR='22104'

SELECT * FROM DHC_INVPRT WHERE PRT_Date="2019-6-27"
